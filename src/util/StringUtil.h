...
public:
	...
	*/
	static unsigned long unsignedLongValue(const std::string& cad);
	/** 
		Converts the string into a long
	*/
	static long longValue(const std::string& cad);
	/** 
	...
	*/
	...
	/** 
		Converts the string into a Date. Not Implemented
	*/
	static Date dateValue(const std::string& cad);
	/** 
	...
	*/
	...
	/** 
		Converts a Date a string. Not Implemented
	*/
	static std::string toString(const Date& value);
...
public:
	...
	*/
	...
	/**
		Initilize constructor. Creates an string with n characters.
		@param n Number of characters
		@param c Character to copy.
	*/
	sstring::sstring(size_type n,char c);
