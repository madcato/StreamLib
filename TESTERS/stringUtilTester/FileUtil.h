...
public:
	...
	*/
	static long GetDatedFileName(std::string& path, const std::string& extension = "") throw(Exceptions::FileUtilException*);
	...
	*/
	...
	/**
		Load and read the version information of a dll or exe.
		@return The file version info. The digits are separated by dots ("1.1.0.43")
	*/
